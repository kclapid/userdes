...
<head>
	...
	<title>K•Y•L•A | Activity 8</title>
...
<div class="row welcome text-center">
	<div class="col-12">
		<h1 class="display-4">Grid Layout Design</h1>
	</div>
	<hr>
</div>
</div>	
...
<p>
<center>
<img class="myImg" src="img/4a1.PNG" alt="4x4 layout 1" style="width:100%;max-width:300px;padding-bottom: 10px">
...
<p>
<center>
<img class="myImg" src="img/4b1.PNG" alt="4x4 picture 1" style="width:100%;max-width:300px;padding-bottom: 10px">
...
<!-- 3x3 layout grid -->
<center>
<img class="myImg" src="img/3a1.PNG" alt="3x3 layout 1" style="width:100%;max-width:300px;padding-bottom: 10px">
...
<p>
<center>
<img class="myImg" src="img/3b1.PNG" alt="3x3 picture 1" style="width:100%;max-width:300px;padding-bottom: 10px">
